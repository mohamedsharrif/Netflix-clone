...
const Feature = ({ title, description, image, video, id }) => {
  return (
    <div
      className={`relative mx-auto flex max-w-screen-lg 
    flex-col items-center justify-center ${id % 2 !== 0 ? 
      "sm:flex-row" : "sm:flex-row-reverse"} space-y-4` }
    >
      ...
      <div className="relative flex-1">
        ...
        <video className="absolute top-1 -z-10 sm:top-20 sm:left-16 sm:w-96 " loop muted autoplay="autoplay" src={`./images/${video}`} />
      </div>
    </div>
  );
};
